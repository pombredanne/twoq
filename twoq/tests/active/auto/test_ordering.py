...
class TestAutoOrderQ(AQMixin, AOrderQMixin):
...
class TestAutoOrderingQ(AQMixin, AOrderingQMixin):
...
class TestAutoRandomQ(AQMixin, ARandomQMixin):
...
class TestSyncOrderQ(AQMixin, AOrderQMixin):
...
class TestSyncOrderingQ(AQMixin, AOrderingQMixin):
...
class TestSyncRandomQ(AQMixin, ARandomQMixin):
